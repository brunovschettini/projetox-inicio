...
INSERT INTO pes_tipo_usuario_acesso (id, ds_descricao) SELECT 1, 'Administrador' WHERE NOT EXISTS ( SELECT id FROM pes_tipo_endereco WHERE id = 1);
INSERT INTO pes_tipo_usuario_acesso (id, ds_descricao) SELECT 2, 'Empresa' WHERE NOT EXISTS ( SELECT id FROM pes_tipo_endereco WHERE id = 2);
INSERT INTO pes_tipo_usuario_acesso (id, ds_descricao) SELECT 3, 'Cliente' WHERE NOT EXISTS ( SELECT id FROM pes_tipo_endereco WHERE id = 3);
SELECT setval('pes_tipo_usuario_acesso_id_seq', max(id)) FROM pes_tipo_usuario_acesso;
